...
import { collection, addDoc, Timestamp, where, getDocs, updateDoc, query, doc, onSnapshot } from 'firebase/firestore';
      ...
      while(retries < maxRetries)
      {
        try {
          const response = await axios.post(`https://app.nativenotify.com/api/indie/notification`, {
            subID: `${friendEmail}`,
            appId: 23657,
            appToken: '7vNsZwTHZVG4GUMWZ2dQxc',
      ...
      <View className='flex-1'>
        {messages[0] !== undefined && (
          <View className="flex-1">
            ...
            />
            <View className='h-[10%] flex-row items-center mx-3 space-x-3 mb-4'>
              <TextInput
