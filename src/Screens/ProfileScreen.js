  ...
  async function DocFinder(queryResult){
    ...
    querySnapshot.forEach((doc) =>{
      if(userName === ''){
        ...
        // console.log("docData aqui -= ", doc.data());
  ...
  return (
    <View>
      <View className='justify-center items-center my-5'>
        <Text className='text-2xl font-medium tracking-widest'>Welcome, <Text className='text-[#d60e45]'>{userName}</Text>  </Text>
      </View>
        <TouchableOpacity onPress={pickImage} className='rounded-md bg-gray-400 items-center justify-center mx-10 mb-10'>
